        ...
        @can('alertify')
            <li class="nav-item dropdown no-arrow mx-1">
                <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown"
                    ...
                    <!-- Counter - Alerts -->
                    <span id="countDashoard"
                        class="badge badge-danger badge-counter">{{Auth::guard('admin')->user()->unreadNotifications->count()}}</span>+
                </a>
                <!-- Dropdown - Alerts -->
                <div id="notifyDashboard" class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                    ...
                    @forelse (Auth::guard('admin')->user()->unreadNotifications as $notify)
                        <a class="dropdown-item d-flex align-items-center"
                            href="{{$notify->data['url']}}?notifyAdmin={{$notify->id}}">
                            <div class="mr-3">
                        ...
                        <a class="dropdown-item text-center small text-gray-500"
                            href="{{route('dashboard.alertify.index')}}">Show All Alerts</a>
                    @empty
                        <span class="font-weight-bold dropdown-item text-center small text-gray-500">No Notifications
                            yet.</span>
                    @endforelse
                </div>
            </li>
